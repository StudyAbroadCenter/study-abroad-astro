...
export const experiencePillars = {
  ja: {
    ...
    title: '日本語を学ぶ\n日本で学ぶ',
    lead: 'RSJP・RWJPシリーズは日本語授業だけで完結しません。立命館の学生と共に学び 京都の文化を自分の手で体験し 街や社会へ学びを広げます。',
    question: '日本語 京都 人との出会い。ひとつの興味から 学びの幅を広げていきます。',
    pillars: [
      {
        id: 'language',
        number: '01',
      ...
      },
      {
        ...
        title: '交流で終わらず 共に学ぶ',
        body: '立命館の学生 学生団体 留学生と一緒に考え 動き つくります。見学する側から キャンパスで共に学ぶ側へ。',
        examples: ['茶道', '和太鼓', '邦楽', '陸上ホッケー', '野球', '学生ガイド', '留学生との交流', 'バディとPBL', 'VR体験', 'グリーンスクリーン', 'Microsoft Base', 'カルタ・折り紙'],
        note: '交流を参加者同士の出会いで終わらせず 共に学ぶ機会につなげます。',
      },
      {
        id: 'culture',
        number: '03',
        ...
        note: '京都の文化を観光だけでなく 学びの対象として捉えます。',
      },
      {
        id: 'field',
        number: '04',
    ...
    outroTitle: '教室を出て 学びを持ち歩く',
    outroBody: '学ぶ場所が変わると 問いも変わります。街で 人と 社会と出会いながら 自分のことばで日本を考えます。',
