...
const cn: Record<ChineseProgrammeId, LocalPage> = {
  ...
  'rwjp-express': {
    ...
    lead: '密集日语课程、文化学习与校园体验集中在约两周内。', campus: '1月：大阪茨木校区（OIC） · 2月：衣笠校区（京都）', status: 'confirmed', statusLabel: `${offers['rwjp-express'].academicYear}主要信息已确认`, statusNote: '日期、最低开班人数、学习时数、住宿基本条件与退款扣除规则已确认。',
