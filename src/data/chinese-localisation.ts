...
const tw: Record<ChineseProgrammeId, LocalPage> = {
  ...
  'rwjp-express': {
    family: '日語與日本文化', title: `${offers['rwjp-express'].academicYear} RWJP Express｜立命館大學`, description: `${offers['rwjp-express'].academicYear} RWJP Express設有1月OIC場次與2月衣笠場次。`, heroAlt: '參加RWJP Express短期日語課程的學生', kicker: `${offers['rwjp-express'].academicYear} · Winter Express · 日語與日本文化`, headline: '用約兩週時間，集中體驗日語學習與日本大學生活。', lead: '密集日語課程、文化學習與校園體驗集中在約兩週內。', campus: '1月：大阪茨木校區（OIC） · 2月：衣笠校區（京都）', status: 'confirmed', statusLabel: `${offers['rwjp-express'].academicYear}主要資訊已確認`, statusNote: '日期、最低開班人數、學習時數、住宿基本條件與退費扣除規則已確認。', overviewTitle: '短期、集中、以日語學習為核心', overviewText: '適合希望在較短時間內集中學習日語並體驗日本大學校園生活的學生。', academicTitle: '22.5小時日語＋360分鐘文化學習', academicIntro: '日語課程1,350分鐘，文化學習360分鐘。', academicItems: ['日語課程1,350分鐘。', 'Japan Studies 360分鐘。', '結合校園學習與交流。'], eligibilityTitle: '以大學在籍學生為對象', eligibilityItems: ['整個課程期間須為大學在籍學生。', '日語零基礎申請者須在開始前能讀寫平假名與片假名。', 'JLPT N1持有者不符合申請資格。'], accommodationTitle: '住宿條件依場次而異', accommodationText: `1月場次不提供大學住宿，參加者須自行安排適合前往OIC的住宿。2月場次可申請大將軍宿舍（先到先得，設施使用費${yen(rwjpExpress2027Sessions.february.accommodationFeeJPY, '待確認')}），或自行安排京都市內、距衣笠校區約30分鐘以內的住宿。`, facts: [{ label: '1月場次', value: `${range(rwjpExpress2027Sessions.january.programmeDates.start, rwjpExpress2027Sessions.january.programmeDates.end, '待確認')} · OIC`, status: '已確認' }, { label: '2月場次', value: `${range(rwjpExpress2027Sessions.february.programmeDates.start, rwjpExpress2027Sessions.february.programmeDates.end, '待確認')} · 衣笠校區`, status: '已確認' }, { label: '最低開班人數', value: offers['rwjp-express'].minimumParticipants === null ? '待確認' : `${offers['rwjp-express'].minimumParticipants}人`, status: offers['rwjp-express'].minimumParticipants === null ? '待確認' : '已確認' }, { label: '日語學習', value: '22.5小時', status: '已確認' }, { label: '文化學習', value: '360分鐘', status: '已確認' }, { label: '付款後退費扣除', value: offers['rwjp-express'].refundDeductionJPY === null ? '待確認' : `${yen(offers['rwjp-express'].refundDeductionJPY, '待確認')}不可退還的行政手續費；其餘金額退還`, status: offers['rwjp-express'].refundDeductionJPY === null ? '待確認' : '已確認' }], nextTitle: `想參加${offers['rwjp-express'].academicYear} RWJP Express？`, nextText: '申請前請確認最終招生簡章與住宿資訊。',
  },
  rdsp: {
