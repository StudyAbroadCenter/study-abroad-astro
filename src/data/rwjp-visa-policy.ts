...
export const rwjpVisaPolicy: RwjpVisaPolicy = {
  ...
  shortAnswerJa: 'ビザが必要な参加者には、プログラム費用の支払完了後、立命館大学が短期滞在ビザ申請に必要な大学側書類を準備します。RWJPは学生ビザではありません。',
  detailJa: 'RWJP参加のために査証が必要な参加者については、プログラム費用の支払完了後、立命館大学が短期滞在ビザ（Temporary Visitor）申請に必要な大学側書類を準備します。RWJPは学生ビザを前提とするプログラムではありません。参加者本人は、自身の国籍・居住地に応じた査証要件を確認し、立命館大学から受け取った書類を用いて、必要な査証申請手続きを行います。',
