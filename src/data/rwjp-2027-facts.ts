...
export const rwjp2027Facts: RwjpFacts = {
  ...
  accommodationKitchen: {
    value: '共用キッチンあり。電子レンジ・冷蔵庫を利用できます。参加者は必要に応じて自炊し、共用スペースまたはキッチンで食事できます。',
    certainty: 'Confirmed',
    source: ownerConfirmation,
    verifiedAt: '2026-08-14',
  },
  ...
  accommodationCommute: {
    value: '衣笠キャンパスまでは徒歩を基本とし、所要時間は約10〜15分です。安全上の理由からプログラム期間中の自転車利用は禁止します。寮の目の前にバス停があり、バスも利用できますが、バス運賃はプログラム費用に含まれません。',
    certainty: 'Confirmed',
    source: ownerConfirmation,
    verifiedAt: '2026-08-14',
  },
