...
export const rwjp2027Facts: RwjpFacts = {
  ...
  paymentPolicy: confirmed('合格後に支払い案内を通知します。プログラム費370,000円と、大将軍寮を利用する場合の宿泊費94,500円は、指定された支払期限までに一括で支払います。具体的な支払方法・手順は合格後に事務局から案内します。支払期限までに支払いが完了しない場合、参加資格は自動的に失効します。'),
