...
export const rwjp2027Facts: RwjpFacts = {
  ...
  refundPolicy: confirmed('参加費を支払う前に辞退する場合、キャンセル料は発生しません。支払後に参加者の自己都合でキャンセルする場合は、54,000円のNon-refundable fee（返金不可手数料）を差し引きます。さらに、キャンセル時点ですでに手配・支出済みで返金できない費用がある場合は、その実費も差し引き、残額がある場合に返金します。'),
