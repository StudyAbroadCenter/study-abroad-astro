...
export const englishProgrammePages: Record<EnglishProgrammePage['id'], EnglishProgrammePage> = {
  rsjp: {
    ...
    title: 'RSJP | Ritsumeikan Summer Japanese Program | Ritsumeikan University',
    description:
      'Explore the Ritsumeikan Summer Japanese Program at Kinugasa Campus in Kyoto. Annual dates, fees, eligibility and accommodation details are published only after verification.',
    ...
    kicker: 'Summer · Japanese Language & Culture',
    ...
    status: 'pending',
    statusLabel: 'Annual details pending verification',
    statusNote:
      'The program identity and Kinugasa Campus location are verified. Dates, fee, eligibility, accommodation and application information for the next offering will appear here only after authoritative confirmation.',
    ...
    highlights: [
      ...
      { value: 'Verified only', label: 'Annual information policy' },
    ],
    academicTitle: 'What the program is designed to combine',
    academicIntro:
      'Exact hours and annual activities are published only when confirmed for the relevant offering.',
    academicItems: [
    ...
    eligibilityTitle: 'Eligibility will be published with the annual offering.',
    eligibilityItems: [
    ...
    accommodationText:
      'Housing arrangements can change by year. The next offering’s accommodation, dates, price and room conditions will be published only after they are verified.',
    facts: [
      { key: 'official-name', label: 'Official name', value: 'Ritsumeikan Summer Japanese Program', status: 'Confirmed' },
      ...
      { key: 'annual-dates', label: 'Next offering dates', value: 'Published after verification', status: 'Pending verification' },
  ...
  'rsjp-express': {
    ...
    name: 'RSJP Express',
    family: 'Japanese Language & Culture',
    title: 'RSJP Express | Ritsumeikan University',
    description:
      'Explore RSJP Express at Kinugasa Campus in Kyoto. Annual dates, fees, eligibility and accommodation details are published only after verification.',
    ...
    kicker: 'Summer Express · Japanese Language & Culture',
    ...
    statusLabel: 'Annual details pending verification',
    statusNote:
      'The program identity and Kinugasa Campus location are verified. The next offering’s dates, fee, eligibility, accommodation and application route are not published until confirmed.',
    ...
    academicIntro:
      'The exact academic load and activity schedule depend on the confirmed offering.',
    academicItems: [
    ...
    accommodationText:
      'Accommodation availability, dates and price are offering-specific and will be shown here when authoritative information is available.',
    facts: [
      { key: 'official-name', label: 'Program name', value: 'RSJP Express', status: 'Confirmed' },
      { key: 'campus', label: 'Campus', value: 'Kinugasa Campus, Kyoto', status: 'Confirmed' },
    ...
    nextTitle: 'Interested in the next RSJP Express?',
    nextText:
  ...
  'rwjp-express': {
    ...
    name: 'RWJP Express',
    family: 'Japanese Language & Culture',
    title: '2027 RWJP Express | Ritsumeikan University',
    description:
      `2027 RWJP Express at Kinugasa Campus in Kyoto runs ${range(rwjpExpress.dates?.start, rwjpExpress.dates?.end)} with 22.5 hours of Japanese study and 360 minutes of cultural learning.`,
    ...
    kicker: '2027 · Winter Express · Japanese Language & Culture',
    ...
    campus: 'Kinugasa Campus, Kyoto',
    status: 'confirmed',
    statusLabel: '2027 core information confirmed',
    statusNote:
      'The 2027 dates, academic load, minimum cohort, payment method, refund deduction rule and Taishogun Dormitory framework below are confirmed. Program fee and application period are not shown because they are not yet verified in the current source boundary.',
    ...
    highlights: [
      ...
      { value: '15', label: 'minimum participants' },
    ],
    academicTitle: 'Confirmed 2027 academic structure',
    academicIntro:
      'The following learning load is confirmed for the 2027 offering.',
    academicItems: [
    ...
    eligibilityTitle: 'Who the 2027 offering is designed for',
    eligibilityItems: [
    ...
    accommodationTitle: 'Taishogun Dormitory is available for the 2027 offering.',
    accommodationText:
    ...
    facts: [
      ...
      { key: 'minimum-participants', label: 'Minimum participants', value: `${rwjpExpress.minimumParticipants ?? 15}`, status: 'Confirmed' },
      { key: 'payment', label: 'Payment method', value: 'Convera', status: 'Confirmed' },
      { key: 'refund', label: 'Post-payment refund deduction', value: 'JPY 27,000 plus any unrecoverable arrangement costs', status: 'Confirmed' },
    ...
    nextTitle: 'Ready to plan for February 2027?',
    nextText:
    ...
    verificationNote:
      `Verified from the current 2027 RWJP Express program-owner confirmation boundary dated ${rwjpExpress.verifiedAt}. Unverified values are intentionally omitted.`,
  },
  ...
  rdsp: {
    ...
    kicker: 'Thematic Study · Osaka Ibaraki Campus',
    ...
    status: 'working',
    statusLabel: 'Current working plan — not final',
    statusNote:
      'The academic themes and current learning framework below come from the program-owner working plan. Annual dates, fee and final recruitment conditions are not confirmed and are therefore not shown as facts.',
    ...
    facts: [
      { key: 'official-name', label: 'Public program name', value: 'RDSP', status: 'Confirmed' },
      { key: 'status', label: '2027 status', value: 'Working plan', status: 'Working plan' },
    ...
    nextText:
      'Use this page to understand the current academic direction, not as a final application notice. Confirmed recruitment information will replace working-plan labels when the program owner signs off.',
    verificationNote:
  ...
  rbmp: {
    ...
    family: 'Thematic Study',
    title: '2027 RBMP Working Plan | Ritsumeikan University',
    description:
      `Review the current 2027 RBMP working plan at Osaka Ibaraki Campus, including ${range(rbmp.dates?.start, rbmp.dates?.end)}, a JPY 200,000 planned fee and eight business and management sessions.`,
    japaneseHref: '/programs/rbmp/',
    heroImage: '/images/IMG_6091.JPG',
    heroAlt: 'Students in a business and management short-term program',
    kicker: '2027 Working Plan · Business & Management',
    ...
    campus: 'Osaka Ibaraki Campus',
    status: 'working',
    statusLabel: '2027 working plan — subject to confirmation',
    statusNote:
      'Dates, planned fee, minimum cohort and learning elements below reflect the current 2027 program-owner working plan. They are clearly marked as working-plan information until final recruitment approval.',
    ...
    highlights: [
      ...
      { value: 'JPY 200,000', label: 'planned program fee' },
      { value: '15', label: 'planned minimum participants' },
    ],
    academicTitle: 'Current 2027 learning design',
    academicIntro:
    ...
    facts: [
      ...
      { key: 'campus', label: 'Campus', value: 'Osaka Ibaraki Campus (OIC)', status: 'Working plan' },
      { key: 'programme-fee', label: 'Planned program fee', value: `JPY ${(rbmp.fee ?? 200000).toLocaleString('en-US')}`, status: 'Working plan' },
      { key: 'minimum-participants', label: 'Planned minimum participants', value: `${rbmp.minimumParticipants ?? 15}`, status: 'Working plan' },
