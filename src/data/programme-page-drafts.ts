...
export const programmePageDrafts: ProgrammePageDraft[] = [
  {
    ...
    lead: '夏の京都で、日本語と日本文化を学ぶ5週間。',
    emphasis: '日本語を軸に、キャンパスでの学びと京都での体験をつなぐプログラムです。年度別の条件は、確認できた情報から掲載します。',
    campus: '衣笠キャンパス（京都）',
  },
  {
    id: 'rsjp-express',
    ...
    category: '日本語・日本文化',
    title: 'RSJP Express',
    lead: '日本語・文化・交流を、夏の2週間に凝縮。',
    emphasis: '2週間でも、イイじゃん。短いからこそ、学ぶ・動く・出会うを濃く。詳細条件は確認できた情報から掲載します。',
    campus: '衣笠キャンパス（京都）',
  },
  {
    id: 'rwjp',
  ...
  },
  {
    ...
    category: '日本語・日本文化',
    title: 'RWJP Express',
    lead: '冬の京都へ。短く、濃く学ぶ2週間。',
    emphasis: '期間は短くても、学びまで薄くしない。RWJPとの違いは、確認済みの事実だけで示します。',
  },
  {
    id: 'rdsp',
    code: 'RDSP',
  ...
  },
  {
    ...
    lead: 'ビジネスを、教室の外まで。',
    emphasis: 'Business Managementを中心に検討中の新規プログラムです。確認できた企画内容から、学びと参加価値を具体化します。',
