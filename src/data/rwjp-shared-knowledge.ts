...
export const rwjpSharedKnowledge: RwjpKnowledgeEntry[] = [
  ...
  {
    id: 'rwjp.academic.grade-scale',
    category: 'academic',
    title: '成績評価の段階',
    question: 'RWJPの成績はどのような評価段階ですか？',
    shortAnswer: '成績はA+、A、B、C、Fの5段階です。成績不良の場合はFとなります。',
    detail: 'RWJPの成績評価はA+、A、B、C、Fの5段階で行います。評価基準を満たさない場合はFとなります。',
    ...common,
  },
  {
    ...
    category: 'academic',
    title: '成績表・修了証書と修了要件',
    question: '成績表や修了証書は発行されますか？発行条件はありますか？',
    shortAnswer: '成績表と修了証書を発行します。日本語講座と日本文化体験のそれぞれで3分の2以上の出席が必要です。',
    detail: 'RWJPでは成績表と修了証書を発行します。発行には、日本語講座と日本文化体験のそれぞれについて、全実施回数の3分の2以上に出席することが必要です。どちらか一方だけではなく、両方でこの出席要件を満たす必要があります。',
    ...common,
  },
  {
    id: 'rwjp.academic.no-credit',
    category: 'academic',
    title: '単位の取扱い',
    question: 'RWJP参加により立命館大学の単位は取得できますか？',
    shortAnswer: 'RWJPでは立命館大学の単位は発行されません。',
    detail: 'RWJPでは成績評価、成績表、修了証書はありますが、立命館大学の正規科目としての単位は発行されません。所属大学での単位認定の可否については、参加者自身が所属大学へ確認してください。',
    ...common,
  },
];
